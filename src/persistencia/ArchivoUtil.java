...
//		Empresa empresa = null;
	...
	public static ArrayList<String> leerPropertiesModalidad(String rutaArchivo){
		...
		try {
			...
			modalidades.add(propiedades.get("modalidad1").toString());
			modalidades.add(propiedades.get("modalidad2").toString());
